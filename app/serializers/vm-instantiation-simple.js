...
export default ApplicationSerializer.extend({
  extractSingle: function(store, primaryType, payload, recordId, requestType) {
    ...
    var slo_gates = payload.vm_instantiation_simple.slo_gates;
    var slo_gate_ids = slo_gates.mapProperty('slo_id');
    var ranked_nodes = payload.vm_instantiation_simple.ranked_nodes;
    var ranked_node_ids = ranked_nodes.mapProperty('node_id');
