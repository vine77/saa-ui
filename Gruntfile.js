          ...
          middleware: function (connect, options) {
            ...
            return [
              connect().use(bodyParser.json()).use(function (req, res, next) {
                ...
                if (req.url === '/api/v3/actions.json' && req.method === 'POST' && req.body.actions[0].name === 'set_agent_mode') {
                      ...
                      "actions": [
                        {
                          ...
                          "name": "set_agent_mode",
                          "links": {
                            "nodes": "/api/v2/nodes/80EBACF7-568B-E311-8DAC-001E674D112D"
                          },
                          "started": "2015-03-09T03:44:18+00:00",
                          "user": null,
                          "options": {
                            "agent_mode": 1
                          },
                          "sla_id": null,
                          "node_id": "80EBACF7-568B-E311-8DAC-001E674D112D",
                          "done": true,
                          "flavor_id": null,
                          "blocking": false,
                          "message": "Set agent mode action for node node-17 has been executed.",
                          "last_update": "2015-03-09T03:44:18+00:00",
                          "vm_id": null,
                          "id": 153,
                          "severity": 3
                        }
