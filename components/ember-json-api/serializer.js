(function() {
  ...
  //Note from Alex: JSONSerializer does not do _id for relationships.
  //Which is why the extension of this did not work, instead I opted for RESTSerializer
  ...
  DS.JsonApiSerializer = DS.RESTSerializer.extend({
    ...
    extract: function() {
      ...
      //this.extractMany.apply(this, json, type, records);
    },
