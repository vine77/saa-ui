    ...
    itemViewClass: Ember.View.extend({
      ...
      template: function () {
        if (this.get('isListItem')) {
          return Ember.Handlebars.compile('<li {{bind-attr class="view.isDisabled:disabled"}}><a {{action "'+this.get('content.method')+'" view.node}}><i class="'+this.get('content.icon')+'"></i> '+this.get('content.name')+'</a></li>');
        }
